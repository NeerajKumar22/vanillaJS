...
a) question itself
b) the answer from which the player can choose the correct one (choose a adequate data structure
...
4. Select one random question and log it on the console, together with the possible answer( each
  question should have a number) (Hint: write a method for the Questions objects for this task)
...
9. Be careful: after Task 8, the game literally never ends. So include the option to quit the
  game if the users writes "exit". instead of the answer. In this case, DON'T call the function
  from task 8.

10. Track the user's score to make the game more fun! So each time an answer is correct, and 1
  point to the score (HINT: I'm going to use the power of closures for this, but you don't have
  to, just do this with the tools you feel more comfortable at this point).
